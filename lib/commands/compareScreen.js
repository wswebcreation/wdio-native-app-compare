...
import { determineIgnoreRectangles } from '../methods/determineIgnoreRectangles'
...
export default async function compareScreen(tag, options = {}) {
    ...
    const screenshotData = await browser.saveScreen(tag, true)
    ...
    screenCompareOptions.ignoreRectangles = await determineIgnoreRectangles(screenshotData.base64Screenshot, screenCompareOptions)
