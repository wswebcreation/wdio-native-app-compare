...
import Rectangles from '../helpers/rectangles';
...
export default async function compareScreen(tag, options = {}) {
    ...
    screenCompareOptions.ignoreRectangles = await Rectangles.determineIgnoreRectangles(bufferedScreenshot, screenCompareOptions);

    return await Compare.execute(this.folders, fileName, screenCompareOptions);
}
