 ...
 * @return {string}
 */
export function formatFileName(capabilities, formatString, tag) {
    const defaults = {
 ...
 * @return {string}
 */
export function getAndCreatePath(capabilities, folder, savePerDevice) {
 ...
 * }
 */
export function determineFileData(capabilities, folder, formatString, tag) {
 ...
 * @return {boolean}
 */
export function determineIphoneXSeries(screenSize) {
    return (
 ...
 * @return {boolean}
 */
export function determineLargeIphoneXSeries(screenSize) {
    return (
