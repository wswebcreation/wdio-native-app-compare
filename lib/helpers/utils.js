...
import { IPHONE_X_MAX_SIZE, IPHONE_X_SIZE, NO_DEVICE_NAME, IPHONE_12_SIZE } from './constants'
...
/**
 * Determine if this is a iphone 12 series phone
 *
 * @param {object} screenSize
 * @param {number} screenSize.height
 * @param {number} screenSize.width
 ...
 * @return {boolean}
 */
function determineIphone12(screenSize) {
    return screenSize.width === IPHONE_12_SIZE || screenSize.height === IPHONE_12_SIZE
}
