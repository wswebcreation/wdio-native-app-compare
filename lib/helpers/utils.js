...
function determineSmallIphone(screenSize) {
    return screenSize.width === IPHONE_SMALL_SIZE || screenSize.height === IPHONE_SMALL_SIZE
}
...
function determineLargeIphone(screenSize) {
    return screenSize.width === IPHONE_LARGE_SIZE || screenSize.height === IPHONE_LARGE_SIZE
}
...
function determineMediumIphone(screenSize) {
    return screenSize.width === IPHONE_MEDIUM_SIZE || screenSize.height === IPHONE_MEDIUM_SIZE
}
...
function determineExtraLargeIphone(screenSize) {
    return screenSize.width === IPHONE_EXTRA_LARGE_SIZE || screenSize.height === IPHONE_EXTRA_LARGE_SIZE
}
