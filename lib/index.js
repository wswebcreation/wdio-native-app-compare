...
import { defaultCompareOptions } from './helpers/compare';
import {
    ACTUAL,
...
import { determineFolder } from './helpers/utils';
...
class WdioNativeAppCompare {
    constructor(browser, options) {
        ...
        this.compareOptions = defaultCompareOptions(options);
        ...
        this.folders = {
            actual: determineFolder(join(baseFolder, ACTUAL), this.savePerDevice),
            baseline: determineFolder(baselineFolder, this.savePerDevice),
            diff: determineFolder(join(baseFolder, DIFF), this.savePerDevice),
        };
