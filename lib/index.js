...
export default class WdioNativeAppCompare {
    ...
    before(capabilities) {
        ...
        // Determine folders
        const baselineFolder = normalize(nativeAppCompareOptions.baselineFolder || DEFAULT_BASELINE_FOLDER)
        const baseFolder = normalize(nativeAppCompareOptions.screenshotPath || DEFAULT_SCREENSHOTS_FOLDER)
