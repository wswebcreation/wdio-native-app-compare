...
(function (root, factory) {
    ...
    var resemble = function (fileData) {
        ...
        var boundingBox;
        var ignoredBox;
        // var largeImageThreshold = 1200;  // Removed it to be able to provide it for nodejs
        ...
        // Added new to make a black blockout
        function copyBlackPixel(px, offset, pix) {
            if (errorType === 'diffOnly') {
                return;
            }
                ...
                if (ignoreRectangles) {
                    for (rectagnlesIdx = 0; rectagnlesIdx < ignoreRectangles.length; rectagnlesIdx++) {
                        ...
                        if (
                            ...
                            copyBlackPixel(pix, offset, pixel2);
                            return;
                        }
                    }
                }
    ...
    resemble.compare = function (image1, image2, options, cb) {
        ...
        largeImageThreshold = opt.largeImageThreshold || 0;
