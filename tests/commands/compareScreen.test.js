...
describe('compareScreen', () => {
    ...
    it('should be able to return compare screen data', async function () {
        ...
        instanceCompareOptionsSpy = jest
            ...
            .mockReturnValue({})
        determineIgnoreRectanglesSpy = jest
            .spyOn(Regtangles, 'determineIgnoreRectangles')
            .mockResolvedValue([])
        ...
        expect(determineIgnoreRectanglesSpy).toBeCalledWith(
            saveScreenData.base64Screenshot,
            options
        )
        expect(executeCompareSpy).toBeCalledWith(
            saveScreenData.folders,
            saveScreenData.fileName,
            options
        )
